...
xcopy			/y				.\Engine\Resources\Code\*.h		.\Reference\Header\
...
xcopy			/y				.\Engine\Utility\Bin\Utility.dll		.\MFCTool\Bin\
xcopy			/y				.\Engine\Resources\Bin\Resources.dll	.\MFCTool\Bin\
