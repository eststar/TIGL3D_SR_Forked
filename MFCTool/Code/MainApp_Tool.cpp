...
HRESULT CMainApp_Tool::Ready_Resource(/*LPDIRECT3DDEVICE9& pGraphicDev*/)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Textures(m_pGraphicDev, RESOURCE_STAGE, L"Texture_Grass", Engine::TEX_NORMAL, L"../../Client/Bin/Resource/Test/Texture/Terrain/Grass_%d.tga", 2), E_FAIL);
